                                ...
                                <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                    ...
                                    <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                        ...
                                        >
                                            ...
                                            Retina 4.5K, 8GB, SSD 256GB, 10-core
                                ...
                                <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                    ...
                                    <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                        ...
                                        >
                                            ...
                                            41mm Midnight Aluminum Case with
                                            Midnight Sport Band
                                        </a>
                                ...
                                <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                    ...
                                    <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                        <a
                                            ...
                                            class="text-base font-medium text-gray-900 hover:underline dark:text-white"
                                        >
                                            Apple - MacBook Pro 16" Laptop, M3
                                            Pro chip, 36GB Memory, 18-core GPU,
                                            512GB SSD, Space Black
                                        </a>
                                ...
                                <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                    ...
                                    <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                        <a
                                            ...
                                            class="text-base font-medium text-gray-900 hover:underline dark:text-white"
                                        >
                                            Tablet APPLE iPad Pro 12.9" 6th Gen,
                                            128GB, Wi-Fi, Gold
                                        </a>
                                ...
                                <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                    ...
                                    <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                        <a
                                            ...
                                            class="text-base font-medium text-gray-900 hover:underline dark:text-white"
                                        >
                                            APPLE iPhone 15 5G phone, 256GB,
                                            Gold
                                        </a>
